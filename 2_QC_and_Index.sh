...
################################################################################
echo "Starting 2_QC_and_Index.sh... "$(date)
################################################################################
...
refFlat=/geschwindlabshares/RNAseq_singlecellfetal/source/Homo_sapiens.GRCh37.75.dna.primary_assembly_NoERCC.refFlat
...
echo "End of 2_QC_and_Index.sh... "$(date)
